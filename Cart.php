...
?>
  ...
  <?php echo '<h1>Shopping Cart of '.$_SESSION['use']. '</h1>';?>
  </div>
  <div class="container">
...
?>
 ...
 <br>
  ...
  <br>
  <form action="prevresnew.php">
 <button type="submit" class="btn btn-danger"  name="goback">Go back to search results</button>
 </form>
 </div>
