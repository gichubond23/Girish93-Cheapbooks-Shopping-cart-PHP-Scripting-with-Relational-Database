...
$querystring="INSERT INTO shoppingbasket VALUES('".$BasketID."','".$_SESSION['use']."');";
...
$querystring.="INSERT INTO contains VALUES('".$value['ISBN']."','".$BasketID."','".$value['Quantity']."');";
}
?>
...
{
echo '<script>alert("Cart added to database");</script>';
}
else
{
